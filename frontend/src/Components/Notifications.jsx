...
async function getfollowers(){
  const res= await axios.post('http://localhost:3000/api/v1/user/followerequests',{},{
...
<div onClick={()=>{
  ...
  <img className='rounded-full w-16 h-16 flex-shrink-0 mr-4 object-cover' src={request.profileImage ? request.profileImage : 'http://localhost:3000/uploads/nouserimage.png'} alt="Profile" />
  <div>
