...
//   );
// Middleware Setup
app.options('https://blog-website-git-master-saharsh-vahsishthas-projects.vercel.app', (0, cors_1.default)()); // Include before your other routes
app.use((0, cors_1.default)({
    origin: 'https://blog-website-git-master-saharsh-vahsishthas-projects.vercel.app', // This should be the URL of your frontend
...
app.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', 'https://blog-website-git-master-saharsh-vahsishthas-projects.vercel.app');
